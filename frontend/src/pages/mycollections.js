...
function MyCollection() {
    ...
    let handleSubmit = async (event) => {
        ...
        let res = await collection_services.change_collection_category(collection_id, category, Cookies.get('token'));
    ...
    return (
        <main>
            <MDBContainer>
                <MDBBtn style={{ marginTop: 17 }} color='light' href='/create-collection'> Create Collection 📐 </MDBBtn>
