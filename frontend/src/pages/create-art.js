...
import { MDBModal, MDBModalBody, MDBModalContent, MDBModalDialog, MDBModalHeader, MDBBtn, MDBModalTitle } from 'mdb-react-ui-kit';
...
function CreateArt() {
    ...
    let handleSubmit = async (event) => {
        ...
        let res = await mint_services.pre_mint(asset, name, description, category, token, amount);
        ...
        try {
            if (res != null) {
                ...
                setSatus("✅ Check out your transaction on Etherscan: https://ropsten.etherscan.io/tx/" + txHash);
                setProgress(false);
            }
    ...
    return (
        <div>
            <form action="" id="create-nft__form" onSubmit={handleSubmit}>
                ...
                <input type="number" placeholder="1" defaultValue={1} name="mint-count" />
                ...
                <button type="submit" className="btn-hover color-9">Create</button>
            ...
            <MDBModal show={showModal} setShow={setModal} tabIndex='-1'>
                <MDBModalDialog>
                    <MDBModalContent>
                        <MDBModalHeader>
                            <MDBModalTitle style={{ justifyContent: "center", textAlign: "center" }}>Creating NFT</MDBModalTitle>
                            <MDBBtn className='btn-close' color='none' onClick={setModal}></MDBBtn>
                        </MDBModalHeader>
                        <MDBModalBody style={{ justifyContent: "center", textAlign: "center", overflowWrap: 'break-word' }}>
                            <h3>{nft_status}</h3>
                            <div style={{ justifyContent: "center", marginLeft: 200 }} >

                                {progress ? <ReactLoading type={"spokes"} color={"#0000DF"} /> : ''}
